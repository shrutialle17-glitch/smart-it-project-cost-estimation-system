...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(user.role === "admin" ? "/admin" : "/admin");
    } catch (err) {
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-navy-900 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center">
          <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-8 animate-float">
          ...
          <p className="text-indigo-200/70 max-w-sm">
            Sign in to access your project estimations.
          </p>
        </div>
      </div>
